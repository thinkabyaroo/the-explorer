            ...
            <div class="col-lg-10 col-xl-8">
                <div class="post mb-4">
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col col-md-4 form-floating mb-4">
                                <img src="{{ asset("storage/cover/".$post->cover) }}" class="cover-img rounded-3 mb-4 w-100 h-100" alt="">
                            </div>
                            <div class="col col-md-6 form-floating mb-4 ms-auto">
                        ...
                        @if($post->galleries->count())
                            <div class="gallery border rounded mb-5">
                                <h5 class="text-center fw-bold mt-4">Post Gallery</h5>
                        ...
                        <div class="mb-5">
                            <div class="row justify-content-center">
                                <h5 class="text-center fw-bold mb-4">Users Comment</h5>
                                <div class="col col-6">
                                    <div class="comments">
                                    ...
                                    @auth
                                        <form action="{{ route('comment.store') }}" method="post" id="comment-create">
                                            ...
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control @error('message') is-invalid @enderror" name="message" placeholder="Leave a comment here" style="height: 100px" id="floatingTextarea"></textarea>
